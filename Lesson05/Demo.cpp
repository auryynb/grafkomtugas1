...
void Demo::DrawColoredCubee()
{
	...
	glm::mat4 model;
	model = glm::translate(model, glm::vec3(4.5, 3, 1));

	model = glm::rotate(model, angle, glm::vec3(0, 0, 3));
...
void Demo::DrawColoredCubef()
{
	...
	model = glm::scale(model, glm::vec3(0.5, 0.5, 6));
